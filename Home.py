...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;margin-top:2rem;">
  ...
  <div style="background:#141820;border:1px solid #2a3348;border-top:4px solid #3a9dff;border-radius:8px;padding:2rem 1.8rem;">
    <div style="font-family:'Barlow Condensed',sans-serif;font-size:2rem;font-weight:800;color:#3a9dff;letter-spacing:0.05em;">PITCH SHAPE ADVISOR</div>
    <div style="color:#8a94aa;font-size:0.88rem;margin-top:0.6rem;line-height:1.6;">
      Enter a pitcher's physical metrics — arm angle, velo, spin, axis, movement — and get MLB-calibrated recommendations on spin axis targets, movement profiles, and pitch design.
    </div>
    <div style="margin-top:1.5rem;display:flex;gap:0.75rem;flex-wrap:wrap;">
      <span style="background:rgba(58,157,255,0.12);color:#3a9dff;font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:0.3rem 0.7rem;border-radius:3px;">MLB Benchmarks</span>
      <span style="background:rgba(58,157,255,0.12);color:#3a9dff;font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:0.3rem 0.7rem;border-radius:3px;">Spin Profile</span>
      <span style="background:rgba(58,157,255,0.12);color:#3a9dff;font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:0.3rem 0.7rem;border-radius:3px;">Shape Targets</span>
    </div>
  </div>
...
with c2:
    st.page_link("pages/2_Pitch_Shape_Advisor.py", label="Open Pitch Shape Advisor →", icon="🔬")
with c3:
